...
class LabelProcessor:
    ...
    def combine_label_maps(basic_map: Dict[str, int], incremental_map: Dict[str, int], combined_map_save_path: str) -> Dict[str, int]:
        ...
        # 통합 라벨 맵 저장
        os.makedirs(os.path.dirname(combined_map_save_path), exist_ok=True)
