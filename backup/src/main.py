...
def main():
    ...
    if args.mode == 'train':
        ...
        inc_grouped = data_manager.load_data_grouped_by_label(config.INCREMENTAL_DATA_PATH, incremental_label_map)
        basic_grouped = data_manager.load_data_grouped_by_label(config.BASIC_DATA_PATH, basic_label_map)
